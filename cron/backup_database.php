 ...
 *
 * Creates a full backup of every configured database (user, content, shop, invoice/rech).
...
$databases = [
    ...
    [
        'label'  => 'shop',
        'host'   => DB_SHOP_HOST,
        'port'   => '3306',  // no separate port constant defined for shop DB (see config/config.php)
        'dbname' => DB_SHOP_NAME,
        'user'   => DB_SHOP_USER,
        'pass'   => DB_SHOP_PASS,
    ],
